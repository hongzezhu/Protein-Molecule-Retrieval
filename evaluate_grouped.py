...
def evaluate_bidirectional(config_path, checkpoint_path):
    # 1. Setup
    ...
    # 2. Extract Features (Bidirectional)
    print("\n⚡ Extracting features for BOTH directions...")
...
if __name__ == "__main__":
    ...
    CHECKPOINT = "/home/zhuhongze/Fajie/lightning_logs/version_19/checkpoints/best-checkpoint-epoch=15-valid_loss=3.67.ckpt"
    
    evaluate_bidirectional(CONFIG, CHECKPOINT)